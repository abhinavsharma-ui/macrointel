...
OUT_JSON = Path("reports/nse_calm_candidate_v2_conservative.json")
OUT_CSV = Path("reports/nse_calm_candidate_v2_conservative_trades.csv")
...
def main():
    ...
    print("\n=== SINGLE CONSERVATIVE RUN COMPLETE ===")
